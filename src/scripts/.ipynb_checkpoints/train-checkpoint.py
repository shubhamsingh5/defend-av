...
def train(env, agent, config, log_dir, visualizer):
    ...
    for episode in pbar:
        ...
        while True:
            ...
            adversarial_state = agent.generate_adversarial_examples(state)
            adversarial_action = agent.select_action(adversarial_state, training=True)
            
            next_state, reward, terminated, truncated, info = env.step(action)
            adversarial_next_state, adv_reward, _, _, _ = env.step(adversarial_action)
